...
-- Free-form Product Delivery Details uses the existing products.delivery_text
-- storage, preserving the current schema and legacy admin command.
...
BEGIN
  ...
  INSERT INTO orders(
    ...
    jsonb_build_object(
      ...
      'delivery_details', COALESCE(v_product.delivery_text, ''),
